...
#const dimensions = (0.0, 150.0, 0.0, 100.0)
const dimensions = (85.0, 115.0, 5.0, 16.0)
#const xyspacing = (25.0, 5.0)
const xyspacing = (2.0, 1.0)
const model_figsize = (8.0, 4.0)
const marker_size = 4.0
...
function marker_plots(;
    ...
    plot_markers(
        ...
        figsize = model_figsize,
        figure_dpi = 200.0,
        xy_location_contour_legend = (-20.0, -20.0),
        marker_size=marker_size, decimation_factor=1,
