...
const ROOT_PATH_OUTPUT = "/mnt/extradrive1/earthbox_output/sdr_formation"
const ROOT_PATH_STORAGE = "/mnt/extradrive2/earthbox_output/sdr_formation"
...
function initialize_stokes_continuity_solver(
    ...
    GlobalPlasticityLoop.initialize!(
        ...
        tolerance_picard       = case_parameters[PARAMS.tolerance_picard.name].value,
        nglobal                = case_parameters[PARAMS.nglobal.name].value,
    )
    return nothing
end
...
function initialize_advection_model(
    ...
    Advection.initialize!(
        ...
        marker_cell_displ_max             = case_parameters[PARAMS.marker_cell_displ_max.name].value, # fraction
...
function initialize_surface_processes_model(
    ...
    SurfaceProcesses.SedimentTransport.initialize!(
        ...
        pelagic_sedimentation_rate      = case_parameters[PARAMS.pelagic_sedimentation_rate.name].value,
