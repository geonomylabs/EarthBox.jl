...
const MATERIAL_COLLECTION = MaterialLibraryCollection.MaterialCollection(
    MaterialLibrary().lithospheric_deformation.lithospheric_deformation_eb1.materials,
    joinpath(@__DIR__, "lithospheric_deformation_eb1_oc_dry.yml"),
)
