...
""" Plot marker extractable meltfrac.

Plots extractable melt fraction markers with optional contours based on the 
...
"""
function plot_filtered_extractable_meltfrac(
    ...
    marker_scalar_array = marker_arrays.marker_extractable_meltfrac
    label = "Extractable Melt Fraction"
    ...
    if plot_marker_scalars == 1 || plot_contours == 1
        println(">> Plotting extractable meltfrac")
