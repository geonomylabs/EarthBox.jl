module LithosphericContractionFixedBCAsymmetric
...
function set_bcs!(model::ModelData)
    vx = model.bcs.parameters.velocity.full_velocity_contraction.value
    ContractionInflowAlongBottom.calc_velocity!(
        model, use_asymmetric_inflow_outflow=true)
