...
const xsize          = 150_000.0 # meters
const ysize          = 100_000.0 # meters
const marker_spacing = 100.0 # 60.0 m for high res
...
function initialize_marker_output(eb::EarthBoxState)::Nothing
    ...
    marker_output[keys.marker_extractable_meltfrac] = true
...
function initialize_boundary_conditions(eb::EarthBoxState)::Nothing
    ...
    BoundaryConditions.Temperature.initialize!(
        ...
        temperature_bottom = ConversionFuncs.celsius_to_kelvin(900.0)
        )
    return nothing
end
